...
public class SectionTitleAdapter extends RecyclerView.Adapter<SectionTitleAdapter.VH> {
    ...
    public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        h.title.setTextColor(ObsidianTheme.textColor(0xCC));
        // Accent bar follows DST accent colour
        h.accentBar.setBackgroundColor(ObsidianTheme.accentColor());
    }
    ...
    static class VH extends RecyclerView.ViewHolder {
        ...
        VH(View v) {
            ...
            accentBar = v.findViewById(R.id.sectionAccentBar);
        }
    }
}

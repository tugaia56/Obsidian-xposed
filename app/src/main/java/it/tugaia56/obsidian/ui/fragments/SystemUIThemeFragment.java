...
/**
 * Stile SystemUI OOS — compila l'overlay per com.android.systemui a partire dal bundle
 * fisso (colori, drawable dialoghi COUI, toast, popup) estratto dal tema Substratum
 * type3_OxygenOS_16 dell'utente. Stesso schema di SettingsThemeFragment: un solo overlay
 * statico, Applica/Disabilita, nessuna opzione.
 */
public class SystemUIThemeFragment extends Fragment {

    private static final String TAG = "SystemUIThemeFragment";
    private static final String PREFIX = "ObsidianComponent";
    private static final String OVERLAY = PREFIX + "SUT1.overlay";
    private static final String KEY_APPLIED = "systemui_theme_applied";
    private static final String KEY_PENDING_REBOOT = "systemui_theme_pending_reboot";
    ...
    private void onApplyClicked() {
        ...
        new Thread(() -> {
            boolean erroredOut;
            try {
                erroredOut = SystemUIThemeCompiler.buildOverlay();
            } catch (IOException e) {
    ...
    private class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.VH> {
        ...
        @NonNull @Override public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            tv.setText(R.string.systemui_theme_notice);
    ...
    private class CardAdapter extends RecyclerView.Adapter<CardAdapter.VH> {
        ...
        @NonNull @Override public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            title.setText(R.string.systemui_theme_card_title);
            ...
            desc.setText(R.string.systemui_theme_card_desc);

...
/**
 * Status bar icon color sub-screen: FabricatedOverlay on all type1b SystemUI color resources.
 */
public class StatusbarSbiFragment extends Fragment {

    private static final String SBI_OVERLAY = "SBI";
    private static final String[] SBI_NAMES = {
        "SBI_0",  "SBI_1",  "SBI_2",  "SBI_3",  "SBI_4",  "SBI_5",  "SBI_6",
        "SBI_7",  "SBI_8",  "SBI_9",  "SBI_10", "SBI_11", "SBI_12", "SBI_13",
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        clockColorAdapter = new DarkShadowColorListener(
                clockColorItems,
                this::onClockColorEnabled,
                this::onClockColorDisabled,
                this::onClockColorSwatch
        );
    ...
    private void onSbiSwatch(DarkShadowItem item, int dialogId) {
        ...
        if (getActivity() instanceof MainActivity) {
            ((MainActivity) getActivity()).showColorPickerDialog(
                    dialogId, item.getColor(), false, true, true);
        }
    }
    ...
    private void applySbiColors(int color, Context ctx) {
        ...
        FabricatedUtil.buildAndEnableOverlays(
            new Object[]{sui, "SBI_0",  "color", "navigation_bar_home_handle_dark_color",         hex},
            new Object[]{sui, "SBI_1",  "color", "navigation_bar_home_handle_light_color",        hex},
            new Object[]{sui, "SBI_2",  "color", "navigation_bar_icon_color",                     hex},
            new Object[]{sui, "SBI_3",  "color", "op_nav_bar_key_dark",                           hex},
            new Object[]{sui, "SBI_4",  "color", "op_nav_bar_key_light",                          hex},
            new Object[]{sui, "SBI_5",  "color", "op_nav_bar_key_transparent",                    hex},
            new Object[]{sui, "SBI_6",  "color", "op_home_handle_dark_color",                     hex},
            new Object[]{sui, "SBI_7",  "color", "op_home_handle_light_color",                    hex},
